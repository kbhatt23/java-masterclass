...
public class TicketReservation {
    ...
    public boolean cancel(String confirmationNumber) {
    	return  confirmedList.removeIf(passenger -> passenger.getConfirmationNumber().equals(confirmationNumber)) ? 
    				true  : waitingList.removeIf(passenger -> passenger.getConfirmationNumber().equals(confirmationNumber))
    			;
    }
    ...
    public boolean removePassenger(Iterator<Passenger> iterator, String confirmationNumber) {         
    	...
    	while(iterator.hasNext()) {
    		Passenger next = iterator.next();
    		if(next.getConfirmationNumber().equals(confirmationNumber)) {
    			iterator.remove();
    			return true;
    		}
    	}
